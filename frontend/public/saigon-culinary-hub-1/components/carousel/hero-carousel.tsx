...
const heroImages = [
  { src: "/pho-bowl.jpg", alt: "Phở Bò" },
  { src: "/banh-mi-sandwich.jpg", alt: "Bánh Mì" },
  { src: "/com-tam-rice.jpg", alt: "Cơm Tấm" },
  { src: "/bun-bo-hue.png", alt: "Bún Bò Huế" },
  { src: "/hu-tieu.jpg", alt: "Hủ Tiếu" },
  { src: "/mi-quang.jpg", alt: "Mì Quảng" },
  { src: "/restaurant-1.jpg", alt: "Nhà hàng Sài Gòn" },
  { src: "/restaurant-2.jpg", alt: "Quán ăn vỉa hè" },
]
    ...
    <section className="relative overflow-hidden">
      <div className="container mx-auto px-4 py-16 md:py-24 lg:py-32">
        ...
        >
          ...
          >
            Khám phá Hương Vị <span style={{ color: "#C1440E" }}>Sài Gòn</span>
          </motion.h1>
          ...
          <motion.p
            ...
            variants={itemVariants}
          >
            Hành trình ẩm thực đầy cảm hứng — nơi từng con phố, từng góc chợ đều kể câu chuyện riêng về{" "}
        ...
        <motion.div variants={itemVariants}>
          <div className="flex justify-center mb-12 md:mb-16">
            <Button
              asChild
              size="lg"
              className="py-8 text-xl rounded-full px-8 hover:opacity-90 transition-opacity"
              style={{
